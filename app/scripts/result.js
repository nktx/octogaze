...
function setGestures (r) {
	...
	for (var i = 90; i <= 450; i += 10) {clockwise.push(new Point((SquareSize/2)*Math.cos(toRadians(i)), (SquareSize/2)*Math.sin(toRadians(i)) - SquareSize/2 )); }
	for (var i = 90; i >= -270; i -= 10) {counterclockwise.push(new Point((SquareSize/2)*Math.cos(toRadians(i)), (SquareSize/2)*Math.sin(toRadians(i)) - SquareSize/2 )); }
