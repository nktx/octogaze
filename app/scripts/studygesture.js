...
if (displayedInterface == 'LINE') {
	...
	gestures.push({
		'Color': "#2ECC71",
		'Name': "LT",
		'Points': new Array(new Point(0,0), new Point(SquareSize,0), new Point(SquareSize/2,SquareSize*(-1)), new Point(0,0))
	});

	gestures.push({
		'Color': "#F1C40F",
		'Name': "RT",
		'Points': new Array(new Point(0,0), new Point(SquareSize*(-1),0), new Point(SquareSize*(-1)/2,SquareSize*(-1)), new Point(0,0))
	});
} else {
